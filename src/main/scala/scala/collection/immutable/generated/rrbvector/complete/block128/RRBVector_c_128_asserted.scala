package scala {
    ...
    package immutable {
      package generated {
        package rrbvector.complete.block128 {
          ...
          import scala.collection.parallel.immutable.generated.rrbvector.complete.block128.ParRRBVector_c_128_asserted

          object RRBVector_c_128_asserted extends scala.collection.generic.IndexedSeqFactory[RRBVector_c_128_asserted] {
            def newBuilder[A]: mutable.Builder[A, RRBVector_c_128_asserted[A]] = new RRBVectorBuilder_c_128_asserted[A]();
            implicit def canBuildFrom[A]: scala.collection.generic.CanBuildFrom[Coll, A, RRBVector_c_128_asserted[A]] = ReusableCBF.asInstanceOf[GenericCanBuildFrom[A]];
            lazy private val EMPTY_VECTOR = new RRBVector_c_128_asserted[Nothing](0);
            override def empty[A]: RRBVector_c_128_asserted[A] = EMPTY_VECTOR
          }

          final class RRBVector_c_128_asserted[+A](override private[immutable] val endIndex: Int) extends scala.collection.AbstractSeq[A] with scala.collection.immutable.IndexedSeq[A] with scala.collection.generic.GenericTraversableTemplate[A, RRBVector_c_128_asserted] with scala.collection.IndexedSeqLike[A, RRBVector_c_128_asserted[A]] with RRBVectorPointer_c_128_asserted[A @uncheckedVariance] with Serializable { self =>
            private[immutable] var dirty: Boolean = false;
            override def companion: scala.collection.generic.GenericCompanion[RRBVector_c_128_asserted] = RRBVector_c_128_asserted;
            def length(): Int = endIndex;
            override def lengthCompare(len: Int): Int = endIndex.-(len);
            override def par = new ParRRBVector_c_128_asserted[A](this);
            override def iterator: RRBVectorIterator_c_128_asserted[A] = {
              if (this.dirty)
                {
                  this.stabilize();
                  this.dirty = false
                ...
                ();
              val it = new RRBVectorIterator_c_128_asserted[A](0, endIndex);
              it.initIteratorFrom(this);
              it
            };
            override def reverseIterator: RRBVectorReverseIterator_c_128_asserted[A] = {
              if (this.dirty)
                {
                  this.stabilize();
                  this.dirty = false
                ...
                ();
              val rit = new RRBVectorReverseIterator_c_128_asserted[A](0, endIndex);
            ...
            override def :+[B >: A, That](elem: B)(implicit bf: CanBuildFrom[RRBVector_c_128_asserted[A], B, That]): That = if (bf.eq(IndexedSeq.ReusableCBF))
              (if (this.endIndex.==(0))
  {
    val resultVector = new RRBVector_c_128_asserted[B](1);
...
else
  {
    ...
    val resultVector = new RRBVector_c_128_asserted[B](_endIndex.+(1));
    ...
    if (elemIndexInBlock.==(0))
    ...
    else
      {
        ...
        resultVector
            ...
            override def take(n: Int): RRBVector_c_128_asserted[A] = if (n.<=(0))
              RRBVector_c_128_asserted.empty
            else
              if (n.<(endIndex))
                takeFront0(n)
              else
                this;
            override def dropRight(n: Int): RRBVector_c_128_asserted[A] = if (n.<=(0))
              this
            else
              if (n.<(endIndex))
                ...
                RRBVector_c_128_asserted.empty;
            override def slice(from: Int, until: Int): RRBVector_c_128_asserted[A] = take(until).drop(from);
            override def splitAt(n: Int): scala.Tuple2[RRBVector_c_128_asserted[A], RRBVector_c_128_asserted[A]] = scala.Tuple2(take(n), drop(n));
            override def ++[B >: A, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[RRBVector_c_128_asserted[A], B, That]): That = if (bf.eq(IndexedSeq.ReusableCBF))
              if (that.isEmpty)
                this.asInstanceOf[That]
              else
                if (that.isInstanceOf[RRBVector_c_128_asserted[B]])
                  {
                    val thatVec = that.asInstanceOf[RRBVector_c_128_asserted[B]];
                    if (this.isEmpty)
                      thatVec.asInstanceOf[That]
                    else
                      {
                        val newVec = new RRBVector_c_128_asserted(this.endIndex.+(thatVec.endIndex));
              ...
              super.++(that.seq);
            override def tail: RRBVector_c_128_asserted[A] = if (this.endIndex.!=(0))
              this.drop(1)
            else
            ...
            override def init: RRBVector_c_128_asserted[A] = if (this.endIndex.!=(0))
              dropRight(1)
            else
            ...
            private[immutable] def concatenate[B >: A](currentSize: Int, that: RRBVector_c_128_asserted[B]): scala.Unit = {
            ...
            private def takeFront0(n: Int): RRBVector_c_128_asserted[A] = {
              if (dirty)
                {
                  stabilize();
                  dirty = false
                ...
                ();
              val vec = new RRBVector_c_128_asserted[A](n);
  ...
  "<=5 <==> display5==null ".+:(x$18)
          ...
          final class RRBVectorBuilder_c_128_asserted[A] extends mutable.Builder[A, RRBVector_c_128_asserted[A]] with RRBVectorPointer_c_128_asserted[A @uncheckedVariance] {
            display0 = new Array[AnyRef](128);
            depth = 1;
            private var blockIndex = 0;
            private var lo = 0;
            private var acc: RRBVector_c_128_asserted[A] = null;
            ...
            override def ++=(xs: TraversableOnce[A]): this.type = {
              if (xs.nonEmpty)
                if (xs.isInstanceOf[RRBVector_c_128_asserted[A]])
                  {
                    val thatVec = xs.asInstanceOf[RRBVector_c_128_asserted[A]];
                    if (endIndex.!=(0))
                      {
                        acc = this.result().++(xs);
                        this.clearCurrent()
            ...
            def result(): RRBVector_c_128_asserted[A] = {
            ...
            private def currentResult(): RRBVector_c_128_asserted[A] = {
              val size = blockIndex.+(lo);
              if (size.==(0))
                RRBVector_c_128_asserted.empty
              else
                {
                  val resultVector = new RRBVector_c_128_asserted[A](size);
          ...
          class RRBVectorIterator_c_128_asserted[+A](startIndex: Int, override private[immutable] val endIndex: Int) extends AbstractIterator[A] with Iterator[A] with RRBVectorPointer_c_128_asserted[A @uncheckedVariance] {
            private var blockIndex: Int = _;
            private var lo: Int = _;
            private var endLo: Int = _;
            private var _hasNext: Boolean = _;
            final private[collection] def initIteratorFrom[B >: A](that: RRBVectorPointer_c_128_asserted[B]): Unit = {
              if (_hasNext)
                {
                  focusOn(startIndex);
          ...
          class RRBVectorReverseIterator_c_128_asserted[+A](startIndex: Int, final override private[immutable] val endIndex: Int) extends AbstractIterator[A] with Iterator[A] with RRBVectorPointer_c_128_asserted[A @uncheckedVariance] {
          ...
          private[immutable] trait RRBVectorPointer_c_128_asserted[A] {
            ...
            final private[immutable] def initWithFocusFrom[U](that: RRBVectorPointer_c_128_asserted[U]): Unit = {
            ...
            final private[immutable] def initFrom[U](that: RRBVectorPointer_c_128_asserted[U]): Unit = {
              assert(that.!=(null));
              depth = that.depth;
              that.depth match {
                case 0 => ()
      ...
      package immutable {
        package generated {
          package rrbvector.complete.block128 {
            ...
            class ParRRBVector_c_128_asserted[+A](vector: RRBVector_c_128_asserted[A]) extends ParSeq[A] with GenericParTemplate[A, ParRRBVector_c_128_asserted] with ParSeqLike[A, ParRRBVector_c_128_asserted[A], RRBVector_c_128_asserted[A]] with Serializable {
              override def companion = ParRRBVector_c_128_asserted;
              def this() = {
                this(RRBVector_c_128_asserted.empty[A]);
                ()
              };
              def apply(idx: Int) = vector.apply(idx);
              def length = vector.length;
              def splitter: SeqSplitter[A] = {
                val pit = new ParRRBVectorIterator_c_128_asserted(0, vector.length);
                pit.initIteratorFrom(vector);
                pit
              };
              override def seq: RRBVector_c_128_asserted[A] = vector;
              override def toVector: Vector[A] = vector.toVector;
              class ParRRBVectorIterator_c_128_asserted(_start: Int, _end: Int) extends RRBVectorIterator_c_128_asserted[A](_start, _end) with SeqSplitter[A] {
                final override def remaining: Int = super.remaining;
                def dup: SeqSplitter[A] = {
                  val pit = new ParRRBVectorIterator_c_128_asserted(_end.-(remaining), _end);
                  pit.initIteratorFrom(this);
                  pit
                };
                def split: Seq[ParRRBVectorIterator_c_128_asserted] = {
                  val rem = remaining;
                  if (rem.>=(2))
                    {
                      val splitSize = (1).<<((5).*((31).-(java.lang.Integer.numberOfLeadingZeros(rem))./(7).-(1)));
                      val splitted = new ArrayBuffer[ParRRBVectorIterator_c_128_asserted]();
                      var currentPos = _end.-(remaining);
                      while (currentPos.<(rem)) 
                        {
                          val pit = new ParRRBVectorIterator_c_128_asserted(currentPos, math.min(currentPos.+(splitSize), _end));
                          pit.initIteratorFrom(this);
                          splitted.+=(pit);
                ...
                def psplit(sizes: Int*): Seq[ParRRBVectorIterator_c_128_asserted] = {
                  val splitted = new ArrayBuffer[ParRRBVectorIterator_c_128_asserted]();
                  var currentPos = _end.-(remaining);
                  sizes.foreach(((sz) => {
                    val pit = new ParRRBVectorIterator_c_128_asserted(currentPos, currentPos.+(sz));
                    pit.initIteratorFrom(this);
                    splitted.+=(pit);
                    currentPos.+=(sz)
                  }));
            ...
            object ParRRBVector_c_128_asserted extends ParFactory[ParRRBVector_c_128_asserted] {
              implicit def canBuildFrom[A]: CanCombineFrom[Coll, A, ParRRBVector_c_128_asserted[A]] = new GenericCanCombineFrom[A]();
              def newBuilder[A]: Combiner[A, ParRRBVector_c_128_asserted[A]] = newCombiner[A];
              def newCombiner[A]: Combiner[A, ParRRBVector_c_128_asserted[A]] = new ParRRBVectorCombinator_c_128_asserted[A]()
            }

            private[immutable] class ParRRBVectorCombinator_c_128_asserted[A] extends Combiner[A, ParRRBVector_c_128_asserted[A]] {
              val builder: RRBVectorBuilder_c_128_asserted[A] = new RRBVectorBuilder_c_128_asserted[A]();
              override def size = builder.endIndex;
              override def result() = new ParRRBVector_c_128_asserted[A](builder.result());
              ...
              def combine[B <: A, NewTo >: ParRRBVector_c_128_asserted[A]](other: Combiner[B, NewTo]) = if (other.eq(this))
                this
              else
                {
                  val that = other.asInstanceOf[ParRRBVectorCombinator_c_128_asserted[B]];
