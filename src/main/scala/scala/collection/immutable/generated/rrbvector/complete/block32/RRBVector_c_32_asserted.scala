package scala {
    ...
    package immutable {
      package generated {
        package rrbvector.complete.block32 {
          ...
          import scala.collection.parallel.immutable.generated.rrbvector.complete.block32.ParRRBVector_c_32_asserted

          object RRBVector_c_32_asserted extends scala.collection.generic.IndexedSeqFactory[RRBVector_c_32_asserted] {
            def newBuilder[A]: mutable.Builder[A, RRBVector_c_32_asserted[A]] = new RRBVectorBuilder_c_32_asserted[A]();
            implicit def canBuildFrom[A]: scala.collection.generic.CanBuildFrom[Coll, A, RRBVector_c_32_asserted[A]] = ReusableCBF.asInstanceOf[GenericCanBuildFrom[A]];
            lazy private val EMPTY_VECTOR = new RRBVector_c_32_asserted[Nothing](0);
            override def empty[A]: RRBVector_c_32_asserted[A] = EMPTY_VECTOR;
            final lazy private[immutable] val emptyTransientBlock = new Array[AnyRef](2)
          }

          final class RRBVector_c_32_asserted[+A](override private[immutable] val endIndex: Int) extends scala.collection.AbstractSeq[A] with scala.collection.immutable.IndexedSeq[A] with scala.collection.generic.GenericTraversableTemplate[A, RRBVector_c_32_asserted] with scala.collection.IndexedSeqLike[A, RRBVector_c_32_asserted[A]] with RRBVectorPointer_c_32_asserted[A @uncheckedVariance] with Serializable { self =>
            private[immutable] var transient: Boolean = false;
            override def companion: scala.collection.generic.GenericCompanion[RRBVector_c_32_asserted] = RRBVector_c_32_asserted;
            def length(): Int = endIndex;
            override def lengthCompare(len: Int): Int = endIndex.-(len);
            override def par = new ParRRBVector_c_32_asserted[A](this);
            override def iterator: RRBVectorIterator_c_32_asserted[A] = {
              if (this.transient)
                {
                ...
                ();
              val it = new RRBVectorIterator_c_32_asserted[A](0, endIndex);
              it.initIteratorFrom(this);
              it
            };
            override def reverseIterator: RRBVectorReverseIterator_c_32_asserted[A] = {
              if (this.transient)
                {
                  this.normalize(this.depth);
                  this.transient = false;
                ...
                ();
              val rit = new RRBVectorReverseIterator_c_32_asserted[A](0, endIndex);
            ...
            override def :+[B >: A, That](elem: B)(implicit bf: CanBuildFrom[RRBVector_c_32_asserted[A], B, That]): That = if (bf.eq(IndexedSeq.ReusableCBF))
              {
                val _endIndex = this.endIndex;
                if (_endIndex.!=(0))
                  {
                    val resultVector = new RRBVector_c_32_asserted[B](_endIndex.+(1));
            ...
            override def take(n: Int): RRBVector_c_32_asserted[A] = if (n.<=(0))
              RRBVector_c_32_asserted.empty
            else
              if (n.<(endIndex))
                takeFront0(n)
              else
                this;
            override def drop(n: Int): RRBVector_c_32_asserted[A] = if (n.<=(0))
              this
            else
              if (n.<(endIndex))
                dropFront0(n)
                ...
                RRBVector_c_32_asserted.empty;
            override def dropRight(n: Int): RRBVector_c_32_asserted[A] = if (n.<=(0))
              this
            else
              if (n.<(endIndex))
                ...
                RRBVector_c_32_asserted.empty;
            override def takeRight(n: Int): RRBVector_c_32_asserted[A] = if (n.<=(0))
              RRBVector_c_32_asserted.empty
            else
              if (n.<(endIndex))
                ...
                this;
            override def slice(from: Int, until: Int): RRBVector_c_32_asserted[A] = take(until).drop(from);
            override def splitAt(n: Int): scala.Tuple2[RRBVector_c_32_asserted[A], RRBVector_c_32_asserted[A]] = scala.Tuple2(take(n), drop(n));
            override def ++[B >: A, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[RRBVector_c_32_asserted[A], B, That]): That = if (bf.eq(IndexedSeq.ReusableCBF))
              if (that.isEmpty)
                this.asInstanceOf[That]
              else
                if (that.isInstanceOf[RRBVector_c_32_asserted[B]])
                  {
                    val thatVec = that.asInstanceOf[RRBVector_c_32_asserted[B]];
                    if (this.endIndex.==(0))
                      thatVec.asInstanceOf[That]
                    else
                      {
                        val newVec = new RRBVector_c_32_asserted(this.endIndex.+(thatVec.endIndex));
              ...
              super.++(that.seq);
            override def tail: RRBVector_c_32_asserted[A] = if (this.endIndex.!=(0))
              this.drop(1)
            else
            ...
            override def init: RRBVector_c_32_asserted[A] = if (this.endIndex.!=(0))
              dropRight(1)
            else
            ...
            private def createSingletonVector[B](elem: B) = {
              val resultVector = new RRBVector_c_32_asserted[B](1);
            ...
            private[immutable] def concatenate[B >: A](currentSize: Int, that: RRBVector_c_32_asserted[B]): scala.Unit = {
              ...
              math.max(this.depth, that.depth) match {
                ...
                case 7 => {
                  ...
                  if (that.focus.&(-32).==(0))
                  ...
                  else
                    {
                      ...
                      if (d6.==(null))
                        ...
                        d5 = d6(0).asInstanceOf[Array[AnyRef]];
                      if (d5.==(null))
                        d4 = that.display4
                      else
                        d4 = d5(0).asInstanceOf[Array[AnyRef]];
                  ...
                  if (concat.length.==(2))
                    initFromRoot(concat(0).asInstanceOf[Array[AnyRef]], 7)
                  else
            ...
            private def takeFront0(n: Int): RRBVector_c_32_asserted[A] = {
              if (transient)
                {
                  normalize(depth);
                  transient = false
                ...
                ();
              val vec = new RRBVector_c_32_asserted[A](n);
            ...
            private def dropFront0(n: Int): RRBVector_c_32_asserted[A] = {
              if (transient)
                {
                  normalize(depth);
                  transient = false
                ...
                ();
              val vec = new RRBVector_c_32_asserted[A](this.endIndex.-(n));
              vec.initWithFocusFrom(this);
              if (vec.depth.>(1))
                {
                  vec.focusOn(n);
  ...
  "<=5 <==> display5==null ".+:(x$6)
              ...
              assert(depth.<=(6).&&(display6.==(null)).||(depth.>(0).&&(display6.!=(null))), ({
  ...
  "<=6 <==> display6==null ".+:(x$7)
              ...
              if (transient.`unary_!`)
                {
                  if (display6.!=(null))
                    {
                      assert(display5.!=(null));
                      if (focusDepth.<=(6))
                        assert(display6(focusRelax.>>(30).&(31)).==(display5))
                      else
                        assert(display6(focus.>>(30).&(31)).==(display5))
                    }
                  else
                    ();
                  if (display5.!=(null))
                  ...
                  if (display6.!=(null))
                    {
                      assert(display5.!=(null));
                      if (focusDepth.<=(6))
                        assert(display6(focusRelax.>>(30).&(31)).==(null))
                      else
                        assert(display6(focus.>>(30).&(31)).==(null))
                    }
                  else
                    ();
                  if (display5.!=(null))
                    {
                      assert(display4.!=(null));
                      if (focusDepth.<=(5))
                        assert(display5(focusRelax.>>(25).&(31)).==(null))
                      else
                        assert(display5(focus.>>(25).&(31)).==(null))
                    }
                  else
                    ();
                  if (display4.!=(null))
                    {
                      assert(display3.!=(null));
                      if (focusDepth.<=(4))
                        assert(display4(focusRelax.>>(20).&(31)).==(null))
                      else
                        assert(display4(focus.>>(20).&(31)).==(null))
                    }
                  else
                    ();
                  if (display3.!=(null))
                    {
                      assert(display2.!=(null));
                      if (focusDepth.<=(3))
                        assert(display3(focusRelax.>>(15).&(31)).==(null))
                      else
                        assert(display3(focus.>>(15).&(31)).==(null))
                    }
                  else
                    ();
                  if (display2.!=(null))
                    {
                      assert(display1.!=(null));
                      if (focusDepth.<=(2))
                        assert(display2(focusRelax.>>(10).&(31)).==(null))
                      else
                        assert(display2(focus.>>(10).&(31)).==(null))
                    }
                  else
                    ();
                  if (display1.!=(null))
                    {
                      assert(display0.!=(null));
                      if (focusDepth.<=(1))
                        assert(display1(focusRelax.>>(5).&(31)).==(null))
                      else
                        assert(display1(focus.>>(5).&(31)).==(null))
                    }
                  else
                    ()
                };
              ...
              depth match {
                ...
                case 7 => checkSizes(display6, 7, endIndex)
                case _ => ()
              };
              true
            }
          ...
          final class RRBVectorBuilder_c_32_asserted[A] extends mutable.Builder[A, RRBVector_c_32_asserted[A]] with RRBVectorPointer_c_32_asserted[A @uncheckedVariance] {
            display0 = new Array[AnyRef](32);
            depth = 1;
            private var blockIndex = 0;
            private var lo = 0;
            private var acc: RRBVector_c_32_asserted[A] = null;
            ...
            override def ++=(xs: TraversableOnce[A]): this.type = {
              if (xs.nonEmpty)
                if (xs.isInstanceOf[RRBVector_c_32_asserted[A]])
                  {
                    val thatVec = xs.asInstanceOf[RRBVector_c_32_asserted[A]];
            ...
            def result(): RRBVector_c_32_asserted[A] = {
            ...
            private def currentResult(): RRBVector_c_32_asserted[A] = {
              val size = blockIndex.+(lo);
              if (size.==(0))
                RRBVector_c_32_asserted.empty
              else
                {
                  val resultVector = new RRBVector_c_32_asserted[A](size);
          ...
          class RRBVectorIterator_c_32_asserted[+A](startIndex: Int, override private[immutable] val endIndex: Int) extends AbstractIterator[A] with Iterator[A] with RRBVectorPointer_c_32_asserted[A @uncheckedVariance] {
            private var blockIndex: Int = _;
            private var lo: Int = _;
            private var endLo: Int = _;
            private var _hasNext: Boolean = _;
            final private[collection] def initIteratorFrom[B >: A](that: RRBVectorPointer_c_32_asserted[B]): Unit = {
          ...
          class RRBVectorReverseIterator_c_32_asserted[+A](startIndex: Int, final override private[immutable] val endIndex: Int) extends AbstractIterator[A] with Iterator[A] with RRBVectorPointer_c_32_asserted[A @uncheckedVariance] {
          ...
          private[immutable] trait RRBVectorPointer_c_32_asserted[A] {
            ...
            final private[immutable] var display7: Array[AnyRef] = _;
            ...
            final private[immutable] def initWithFocusFrom[U](that: RRBVectorPointer_c_32_asserted[U]): Unit = {
            ...
            final private[immutable] def initFrom[U](that: RRBVectorPointer_c_32_asserted[U]): Unit = {
              assert(that.!=(null));
              depth = that.depth;
              that.depth match {
                case 0 => ()
            ...
            final private[immutable] def setupNewBlockInNextBranch(xor: Int, transient: Boolean): Unit = if (xor.<(1024))
              {
                if (depth.==(1))
                  {
                    depth = 2;
              ...
              if (xor.<(32768))
                {
                  ...
                  display0 = new Array(1);
                  val _emptyTransientBlock = RRBVector_c_32_asserted.emptyTransientBlock;
                          ...
                          if (xor.>=(33554432))
                            {
                              if (xor.>=(1073741824))
                                ...
                                idx = index.>>(25).&(31);
                              display4 = display5(idx).asInstanceOf[Array[AnyRef]];
                              idx = 0
                            }
                          else
                            idx = index.>>(20).&(31);
            ...
            final private[immutable] def copyDisplaysAndStabilizeDisplayPath(_depth: Int, _focus: Int): Unit = _depth match {
              ...
              case 7 => {
                ...
                d5.update(_focus.>>(25).&(31), d4);
                display5 = d5;
                val d6: Array[AnyRef] = copyOf(display6);
            ...
            private[immutable] def cleanTopDrop(cutIndex: Int): Unit = this.depth match {
              case 2 => if (cutIndex.>>(5).==(display1.length.-(2)))
                {
                  display1 = null;
                  this.depth = 1
                }
                ...
                this.depth = 2
              case 3 => if (cutIndex.>>(10).==(display2.length.-(2)))
                {
                  display2 = null;
                ...
                this.depth = 3
              case 4 => if (cutIndex.>>(15).==(display3.length.-(2)))
                {
                  display3 = null;
                ...
                this.depth = 4
              case 5 => if (cutIndex.>>(20).==(display4.length.-(2)))
                {
                  display4 = null;
                ...
                this.depth = 5
              case 6 => if (cutIndex.>>(25).==(display5.length.-(2)))
                {
                  display5 = null;
                ...
                this.depth = 6
              case 7 => if (cutIndex.>>(30).==(display6.length.-(2)))
                {
                  display6 = null;
            ...
            @inline final private def notBalanced(node: Array[AnyRef], sizes: Array[Int], currentDepth: Int, end: Int) = sizes(end.-(2)).!=(end.-(1).<<((5).*(currentDepth.-(1)))).||(currentDepth.>(2).&&({
      ...
      package immutable {
        package generated {
          package rrbvector.complete.block32 {
            ...
            class ParRRBVector_c_32_asserted[+A](vector: RRBVector_c_32_asserted[A]) extends ParSeq[A] with GenericParTemplate[A, ParRRBVector_c_32_asserted] with ParSeqLike[A, ParRRBVector_c_32_asserted[A], RRBVector_c_32_asserted[A]] with Serializable {
              override def companion = ParRRBVector_c_32_asserted;
              def this() = {
                this(RRBVector_c_32_asserted.empty[A]);
                ()
              };
              def apply(idx: Int) = vector.apply(idx);
              def length = vector.length;
              def splitter: SeqSplitter[A] = {
                val pit = new ParRRBVectorIterator_c_32_asserted(0, vector.length);
                pit.initIteratorFrom(vector);
                pit
              };
              override def seq: RRBVector_c_32_asserted[A] = vector;
              override def toVector: Vector[A] = vector.toVector;
              class ParRRBVectorIterator_c_32_asserted(_start: Int, _end: Int) extends RRBVectorIterator_c_32_asserted[A](_start, _end) with SeqSplitter[A] {
                final override def remaining: Int = super.remaining;
                def dup: SeqSplitter[A] = {
                  val pit = new ParRRBVectorIterator_c_32_asserted(_end.-(remaining), _end);
                  pit.initIteratorFrom(this);
                  pit
                };
                def split: Seq[ParRRBVectorIterator_c_32_asserted] = {
                  val rem = remaining;
                  if (rem.>=(2))
                    {
                      val _half = rem./(2);
                ...
                def psplit(sizes: Int*): Seq[ParRRBVectorIterator_c_32_asserted] = {
                  val splitted = new ArrayBuffer[ParRRBVectorIterator_c_32_asserted]();
                  var currentPos = _end.-(remaining);
                  sizes.foreach(((sz) => {
                    val pit = new ParRRBVectorIterator_c_32_asserted(currentPos, currentPos.+(sz));
                    pit.initIteratorFrom(this);
                    splitted.+=(pit);
                    currentPos.+=(sz)
                  }));
            ...
            object ParRRBVector_c_32_asserted extends ParFactory[ParRRBVector_c_32_asserted] {
              implicit def canBuildFrom[A]: CanCombineFrom[Coll, A, ParRRBVector_c_32_asserted[A]] = new GenericCanCombineFrom[A]();
              def newBuilder[A]: Combiner[A, ParRRBVector_c_32_asserted[A]] = newCombiner[A];
              def newCombiner[A]: Combiner[A, ParRRBVector_c_32_asserted[A]] = new ParRRBVectorCombinator_c_32_asserted[A]()
            }

            private[immutable] class ParRRBVectorCombinator_c_32_asserted[A] extends Combiner[A, ParRRBVector_c_32_asserted[A]] {
              val builder: RRBVectorBuilder_c_32_asserted[A] = new RRBVectorBuilder_c_32_asserted[A]();
              override def size = builder.endIndex;
              override def result() = new ParRRBVector_c_32_asserted[A](builder.result());
              ...
              def combine[B <: A, NewTo >: ParRRBVector_c_32_asserted[A]](other: Combiner[B, NewTo]) = if (other.eq(this))
                this
              else
                {
                  val newCombiner = new ParRRBVectorCombinator_c_32_asserted[A]();
                  newCombiner.++=(this.builder.result());
                  newCombiner.++=(other.asInstanceOf[ParRRBVectorCombinator_c_32_asserted[A]].builder.result());
                  newCombiner
                }
            }
          }
