package scala {
          ...
          final class RRBVector_c_256_asserted[+A](override private[immutable] val endIndex: Int) extends scala.collection.AbstractSeq[A] with scala.collection.immutable.IndexedSeq[A] with scala.collection.generic.GenericTraversableTemplate[A, RRBVector_c_256_asserted] with scala.collection.IndexedSeqLike[A, RRBVector_c_256_asserted[A]] with RRBVectorPointer_c_256_asserted[A @uncheckedVariance] with Serializable { self =>
            ...
            override def take(n: Int): RRBVector_c_256_asserted[A] = if (n.<=(0))
              ...
              if (n.<(endIndex))
                ...
                this;
            override def drop(n: Int): RRBVector_c_256_asserted[A] = if (n.<=(0))
              this
            else
              if (n.<(endIndex))
                dropFront0(n)
            ...
            override def dropRight(n: Int): RRBVector_c_256_asserted[A] = if (n.<=(0))
              ...
              if (n.<(endIndex))
                ...
                RRBVector_c_256_asserted.empty;
            override def takeRight(n: Int): RRBVector_c_256_asserted[A] = if (n.<=(0))
              RRBVector_c_256_asserted.empty
            else
              if (n.<(endIndex))
            ...
            private[immutable] def append[B](elem: B, _endIndex: Int): scala.Unit = {
              if (focusStart.+(focus).^(_endIndex.-(1)).>=(32))
                ...
                ();
              val elemIndexInBlock = _endIndex.-(focusStart).&(255);
            ...
            private def prependFrontNewBlock[B](elem: B): scala.Unit = {
              ...
              while (display.!=(null).&&(display.length.==(257))) 
                {
                  currentDepth.+=(1);
                  currentDepth match {
              ...
              if (leftLength.==(256))
                ...
                if (leftLength.+(rightLength).<=(256))
                ...
                else
                  {
                    ...
                    System.arraycopy(displayRight, 0, arr0, leftLength, (256).-(leftLength));
                    System.arraycopy(displayRight, (256).-(leftLength), arr1, 0, rightLength.-(256).+(leftLength));
                    top
                  }
            };
            ...
            private def dropFront0(n: Int): RRBVector_c_256_asserted[A] = {
              if (transient)
                {
                  normalize(depth);
                  transient = false
                ...
                ();
              val vec = new RRBVector_c_256_asserted[A](this.endIndex.-(n));
              vec.initWithFocusFrom(this);
              if (vec.depth.>(1))
                {
                  vec.focusOn(n);
                  val cutIndex = vec.focus.|(vec.focusRelax);
                  val d0Start = cutIndex.&(255);
                  if (d0Start.!=(0))
                    {
                  ...
                  if (vec.depth.>(1))
                    {
                      ...
                      while (i.<=(vec.depth)) 
                        {
                          val splitStart = cutIndex.>>((8).*(i.-(1))).&(255);
  ...
  "<=3 <==> display3==null ".+:(x$22)
                  ...
                  if (display3.!=(null))
                    {
                      assert(display2.!=(null));
                      if (focusDepth.<=(3))
                        assert(display3(focusRelax.>>(24).&(255)).==(null))
                      else
                        assert(display3(focus.>>(24).&(255)).==(null))
                    }
                  else
                    ();
                  if (display2.!=(null))
                    {
                      assert(display1.!=(null));
                      if (focusDepth.<=(2))
                        assert(display2(focusRelax.>>(16).&(255)).==(null))
                      else
                        assert(display2(focus.>>(16).&(255)).==(null))
                    }
                  else
                    ();
                  if (display1.!=(null))
                    {
                      assert(display0.!=(null));
                      if (focusDepth.<=(1))
                        assert(display1(focusRelax.>>(8).&(255)).==(null))
                      else
                        assert(display1(focus.>>(8).&(255)).==(null))
                    }
                  else
                    ()
                };
                    ...
                    if (sizes.!=(null))
                    ...
                    else
                      {
                        ...
                        while (i.<(node.length.-(2))) 
                          {
                            checkSizes(node(i).asInstanceOf[Array[AnyRef]], currentDepth.-(1), (1).<<((8).*(currentDepth.-(1))));
                            i.+=(1)
                          }
                        ;
          ...
          private[immutable] trait RRBVectorPointer_c_256_asserted[A] {
            ...
            final private[immutable] def setupNewBlockInNextBranch(xor: Int, transient: Boolean): Unit = if (xor.<(65536))
              {
                if (depth.==(1))
                  {
                    depth = 2;
              ...
              if (xor.<(16777216))
                {
                  ...
                  display0 = new Array(1);
                  val _emptyTransientBlock = RRBVector_c_256_asserted.emptyTransientBlock;
            ...
            final private[immutable] def gotoPos(index: Int, xor: Int): Unit = if (xor.<(256))
              ...
              if (xor.<(65536))
                display0 = display1(index.>>(8).&(255)).asInstanceOf[Array[AnyRef]]
              else
                if (xor.<(16777216))
                  {
                    display1 = display2(index.>>(16).&(255)).asInstanceOf[Array[AnyRef]];
                    display0 = display1(index.>>(8).&(255)).asInstanceOf[Array[AnyRef]]
                  }
                else
                  if (xor.<(1))
                    {
                      display2 = display3(index.>>(24).&(255)).asInstanceOf[Array[AnyRef]];
                      display1 = display2(index.>>(16).&(255)).asInstanceOf[Array[AnyRef]];
                      display0 = display1(index.>>(8).&(255)).asInstanceOf[Array[AnyRef]]
                    }
                  else
                  ...
                  do 
                    {
                      ...
                      val idx = stabilizationIndex.>>((8).*(currentLevel)).&(31);
                      currentLevel match {
                        case 1 => {
            ...
            final private[immutable] def copyDisplaysAndNullFocusedBranch(_depth: Int, _focus: Int): Unit = _depth match {
              case 2 => display1 = copyOfAndNull(display1, _focus.>>(8).&(255))
              case 3 => {
                display1 = copyOfAndNull(display1, _focus.>>(8).&(255));
                display2 = copyOfAndNull(display2, _focus.>>(16).&(255))
              }
              case 4 => {
                display1 = copyOfAndNull(display1, _focus.>>(8).&(255));
                display2 = copyOfAndNull(display2, _focus.>>(16).&(255));
                display3 = copyOfAndNull(display3, _focus.>>(24).&(255))
              }
            };
            final private[immutable] def copyDisplaysAndStabilizeDisplayPath(_depth: Int, _focus: Int): Unit = _depth match {
              ...
              case 2 => {
                ...
                d1.update(_focus.>>(8).&(255), display0);
                display1 = d1
              }
              case 3 => {
                val d1: Array[AnyRef] = copyOf(display1);
                ...
                if ((2).<(_depth))
                  {
                    ...
                    d2.update(_focus.>>(16).&(255), d1);
                    if (_depth.==(4))
                      display3.update(_focus.>>(24).&(255), d2)
                    else
                      ()
                  }
                else
            ...
            private[immutable] def cleanTopDrop(cutIndex: Int): Unit = this.depth match {
              case 2 => if (cutIndex.>>(8).==(display1.length.-(2)))
                {
                  display1 = null;
                  this.depth = 1
                }
                ...
                this.depth = 2
              case 3 => if (cutIndex.>>(16).==(display2.length.-(2)))
                {
                  display2 = null;
                  if (cutIndex.>>(8).==(display1.length.-(2)))
                    {
                      display1 = null;
                      this.depth = 1
                    }
                ...
                this.depth = 3
              case 4 => if (cutIndex.>>(24).==(display3.length.-(2)))
                {
                  display3 = null;
                  if (cutIndex.>>(16).==(display2.length.-(2)))
                    {
                      display2 = null;
                      if (cutIndex.>>(8).==(display1.length.-(2)))
                        {
              ...
              if (oldSizes.!=(null))
                {
                  ...
                  if (transient)
                    newSizes.update(len.-(1), (1).<<((8).*(currentLevel)))
                  else
                    ();
            ...
            final private def copyAndIncLeftRoot(node: Array[AnyRef], transient: Boolean, currentLevel: Int) = {
              ...
              if (oldSizes.!=(null))
                ...
                {
                  val subTreeSize = (1).<<((8).*(currentLevel));
                  var acc = 0;
                  var i = 1;
                  while (i.<(len.-(1))) 
                    {
            ...
            @inline final private def notBalanced(node: Array[AnyRef], sizes: Array[Int], currentDepth: Int, end: Int) = sizes(end.-(2)).!=(end.-(1).<<((8).*(currentDepth.-(1)))).||(currentDepth.>(2).&&({
              ...
              def treeSizeRec(node: Array[AnyRef], currentDepth: Int, acc: Int): Int = if (currentDepth.==(1))
              ...
              else
                {
                  ...
                  if (treeSizes.!=(null))
                    ...
                    {
                      val len = node.length;
                      treeSizeRec(node(len.-(2)).asInstanceOf[Array[AnyRef]], currentDepth.-(1), acc.+(len.-(2).*((1).<<((8).*(currentDepth.-(1))))))
                    }
                };
          ...
          package rrbvector.complete.block256 {
            ...
            private[immutable] class ParRRBVectorCombinator_c_256_asserted[A] extends Combiner[A, ParRRBVector_c_256_asserted[A]] {
              ...
              def combine[B <: A, NewTo >: ParRRBVector_c_256_asserted[A]](other: Combiner[B, NewTo]) = if (other.eq(this))
                ...
                {
                  val newCombiner = new ParRRBVectorCombinator_c_256_asserted[A]();
                  newCombiner.++=(this.builder.result());
                  newCombiner.++=(other.asInstanceOf[ParRRBVectorCombinator_c_256_asserted[A]].builder.result());
                  newCombiner
                }
            }
          }
