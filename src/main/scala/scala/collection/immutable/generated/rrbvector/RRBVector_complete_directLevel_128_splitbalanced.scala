package scala {
  ...
  val x$25 = depth.toString;
  "<=0 <==> display0==null ".+:(x$25)
}).:+(depth, display0));
              assert(depth.<=(1).&&(display1.==(null)).||(depth.>(0).&&(display1.!=(null))), ({
  val x$26 = depth.toString;
  "<=1 <==> display1==null ".+:(x$26)
}).:+(depth, display1));
              assert(depth.<=(2).&&(display2.==(null)).||(depth.>(0).&&(display2.!=(null))), ({
  val x$27 = depth.toString;
  "<=2 <==> display2==null ".+:(x$27)
}).:+(depth, display2));
              assert(depth.<=(3).&&(display3.==(null)).||(depth.>(0).&&(display3.!=(null))), ({
  val x$28 = depth.toString;
  "<=3 <==> display3==null ".+:(x$28)
}).:+(depth, display3));
              assert(depth.<=(4).&&(display4.==(null)).||(depth.>(0).&&(display4.!=(null))), ({
  val x$29 = depth.toString;
  "<=4 <==> display4==null ".+:(x$29)
}).:+(depth, display4));
              assert(depth.<=(5).&&(display5.==(null)).||(depth.>(0).&&(display5.!=(null))), ({
  val x$30 = depth.toString;
  "<=5 <==> display5==null ".+:(x$30)
}).:+(depth, display5));
              if (display5.!=(null))
                {
