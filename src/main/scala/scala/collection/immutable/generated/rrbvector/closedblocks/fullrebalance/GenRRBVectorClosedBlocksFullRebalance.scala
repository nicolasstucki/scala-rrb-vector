package scala {
    ...
    package immutable {
      package generated {
        package rrbvector.closedblocks.fullrebalance {
          ...
          object GenRRBVectorClosedBlocksFullRebalance extends scala.collection.generic.IndexedSeqFactory[GenRRBVectorClosedBlocksFullRebalance] {
            def newBuilder[A]: mutable.Builder[A, GenRRBVectorClosedBlocksFullRebalance[A]] = new GenRRBVectorClosedBlocksFullRebalanceBuilder[A]();
            implicit def canBuildFrom[A]: scala.collection.generic.CanBuildFrom[Coll, A, GenRRBVectorClosedBlocksFullRebalance[A]] = ReusableCBF.asInstanceOf[GenericCanBuildFrom[A]];
            private val NIL = new GenRRBVectorClosedBlocksFullRebalance[Nothing](0);
            override def empty[A]: GenRRBVectorClosedBlocksFullRebalance[A] = NIL;
            final private[immutable] def singleton[A](value: A): GenRRBVectorClosedBlocksFullRebalance[A] = {
              val vec = new GenRRBVectorClosedBlocksFullRebalance[A](1);
          ...
          final class GenRRBVectorClosedBlocksFullRebalance[+A](private[immutable] val endIndex: Int) extends scala.collection.AbstractSeq[A] with scala.collection.immutable.IndexedSeq[A] with scala.collection.generic.GenericTraversableTemplate[A, GenRRBVectorClosedBlocksFullRebalance] with scala.collection.IndexedSeqLike[A, GenRRBVectorClosedBlocksFullRebalance[A]] with GenRRBVectorClosedBlocksFullRebalancePointer[A @uncheckedVariance] with Serializable { self =>
            override def companion: scala.collection.generic.GenericCompanion[GenRRBVectorClosedBlocksFullRebalance] = GenRRBVectorClosedBlocksFullRebalance;
            def length(): Int = endIndex;
            override def lengthCompare(len: Int): Int = endIndex.-(len);
            private[collection] def initIterator[B >: A](it: GenRRBVectorClosedBlocksFullRebalanceIterator[B]): scala.Unit = {
              if (this.dirty)
                this.stabilize()
              else
                ();
            ...
            private[collection] def initIterator[B >: A](it: GenRRBVectorClosedBlocksFullRebalanceReverseIterator[B]): scala.Unit = {
              if (this.dirty)
                this.stabilize()
              else
                ();
            ...
            override def iterator: GenRRBVectorClosedBlocksFullRebalanceIterator[A] = {
              val it = new GenRRBVectorClosedBlocksFullRebalanceIterator[A](0, endIndex);
              this.initIterator(it);
              it
            };
            override def reverseIterator: GenRRBVectorClosedBlocksFullRebalanceReverseIterator[A] = {
              val it = new GenRRBVectorClosedBlocksFullRebalanceReverseIterator[A](0, endIndex);
              this.initIterator(it);
              it
            };
            ...
            override def :+[B >: A, That](elem: B)(implicit bf: CanBuildFrom[GenRRBVectorClosedBlocksFullRebalance[A], B, That]): That = if (bf.eq(IndexedSeq.ReusableCBF))
            ...
            override def take(n: Int): GenRRBVectorClosedBlocksFullRebalance[A] = if (n.<=(0))
              GenRRBVectorClosedBlocksFullRebalance.empty
            else
              if (n.<(endIndex))
                takeFront0(n)
              else
                this;
            override def dropRight(n: Int): GenRRBVectorClosedBlocksFullRebalance[A] = if (n.<=(0))
              this
            else
              if (n.<(endIndex))
                ...
                GenRRBVectorClosedBlocksFullRebalance.empty;
            override def slice(from: Int, until: Int): GenRRBVectorClosedBlocksFullRebalance[A] = take(until).drop(from);
            override def splitAt(n: Int): scala.Tuple2[GenRRBVectorClosedBlocksFullRebalance[A], GenRRBVectorClosedBlocksFullRebalance[A]] = scala.Tuple2(take(n), drop(n));
            override def ++[B >: A, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[GenRRBVectorClosedBlocksFullRebalance[A], B, That]): That = if (bf.eq(IndexedSeq.ReusableCBF))
              if (that.isEmpty)
                this.asInstanceOf[That]
              else
                if (that.isInstanceOf[GenRRBVectorClosedBlocksFullRebalance[B]])
                  {
                    val vec = that.asInstanceOf[GenRRBVectorClosedBlocksFullRebalance[B]];
                    if (this.isEmpty)
              ...
              super.++(that.seq);
            override def tail: GenRRBVectorClosedBlocksFullRebalance[A] = if (this.endIndex.!=(0))
              this.drop(1)
            else
            ...
            override def init: GenRRBVectorClosedBlocksFullRebalance[A] = if (this.endIndex.!=(0))
              dropRight(1)
            else
              throw new UnsupportedOperationException("empty.init");
            private def appendedBack[B >: A](value: B): GenRRBVectorClosedBlocksFullRebalance[B] = {
              val res = {
                if (this.endIndex.==(0))
                  return GenRRBVectorClosedBlocksFullRebalance.singleton[B](value)
                else
                  ();
                val _endIndex = this.endIndex;
                val vec = new GenRRBVectorClosedBlocksFullRebalance[B](_endIndex.+(1));
                vec.initFrom(this);
                ...
                if (elemIndexInBlock.==(0))
                ...
                else
                  {
                    ...
                    Platform.arraycopy(vec.display0, 0, d0, 0, elemIndexInBlock);
                    d0.update(elemIndexInBlock, value.asInstanceOf[AnyRef]);
                    vec.display0 = d0;
                    vec
                  }
              };
            ...
            private[immutable] def concatenated[B >: A](that: GenRRBVectorClosedBlocksFullRebalance[B]): GenRRBVectorClosedBlocksFullRebalance[B] = {
              ...
              val vec = new GenRRBVectorClosedBlocksFullRebalance[B](newSize);
                    ...
                    while (i.<(displayEnd)) 
                      {
                        ...
                        val displayValueEnd = displayValue.length.-(if (currentDepth.==(2))
                          ...
                          1);
                        if (iBot.==(0).&&(j.==(0)).&&(displayValueEnd.==(32)))
                          {
  ...
  "<=5 <==> display5==null ".+:(x$6)
          ...
          final class GenRRBVectorClosedBlocksFullRebalanceBuilder[A] extends mutable.Builder[A, GenRRBVectorClosedBlocksFullRebalance[A]] with GenRRBVectorClosedBlocksFullRebalancePointer[A @uncheckedVariance] {
            ...
            def result(): GenRRBVectorClosedBlocksFullRebalance[A] = {
              val res = {
                val size = blockIndex.+(lo);
                if (size.==(0))
                  return GenRRBVectorClosedBlocksFullRebalance.empty
                else
                  ();
                val resultVector = new GenRRBVectorClosedBlocksFullRebalance[A](size);
          ...
          class GenRRBVectorClosedBlocksFullRebalanceIterator[+A](startIndex: Int, endIndex: Int) extends AbstractIterator[A] with Iterator[A] with GenRRBVectorClosedBlocksFullRebalancePointer[A @uncheckedVariance] {
          ...
          private[immutable] trait GenRRBVectorClosedBlocksFullRebalancePointer[A] {
            ...
            private[immutable] def initFrom[U](that: GenRRBVectorClosedBlocksFullRebalancePointer[U]): Unit = {
                      ...
                      while (currentDepth.<=(_depth)) 
                        {
                          currentDepth match {
                            case 2 => {
                              val oldSizes = display1(display1.length.-(1)).asInstanceOf[Array[Int]];
                              ...
                              val idx = stabilizationIndex.>>(5).&(31);
                              display1 = copyOf(display1, idx, idx.+(2));
                              display1.update(idx, display0);
                              display1.update(display1.length.-(1), newSizes)
                            }
                            case 3 => {
                              val oldSizes = display2(display2.length.-(1)).asInstanceOf[Array[Int]];
                              val newSizes = new Array[Int](oldSizes.length);
                              val lastSizesIndex = oldSizes.length.-(1);
                              Platform.arraycopy(oldSizes, 0, newSizes, 0, lastSizesIndex);
                              newSizes.update(lastSizesIndex, oldSizes(lastSizesIndex).+(deltaSize));
                              val idx = stabilizationIndex.>>(10).&(31);
                              display2 = copyOf(display2, idx, idx.+(2));
                              display2.update(idx, display1);
                              display2.update(display2.length.-(1), newSizes)
                            }
                            case 4 => {
                              val oldSizes = display3(display3.length.-(1)).asInstanceOf[Array[Int]];
                              val newSizes = new Array[Int](oldSizes.length);
                              val lastSizesIndex = oldSizes.length.-(1);
                              Platform.arraycopy(oldSizes, 0, newSizes, 0, lastSizesIndex);
                              newSizes.update(lastSizesIndex, oldSizes(lastSizesIndex).+(deltaSize));
                              val idx = stabilizationIndex.>>(15).&(31);
                              display3 = copyOf(display3, idx, idx.+(2));
                              display3.update(idx, display2);
                              display3.update(display3.length.-(1), newSizes)
                            }
                            case 5 => {
                              val oldSizes = display4(display4.length.-(1)).asInstanceOf[Array[Int]];
                              val newSizes = new Array[Int](oldSizes.length);
                              val lastSizesIndex = oldSizes.length.-(1);
                              Platform.arraycopy(oldSizes, 0, newSizes, 0, lastSizesIndex);
                              newSizes.update(lastSizesIndex, oldSizes(lastSizesIndex).+(deltaSize));
                              val idx = stabilizationIndex.>>(20).&(31);
                              display4 = copyOf(display4, idx, idx.+(2));
                              display4.update(idx, display3);
                              display4.update(display4.length.-(1), newSizes)
                            }
                            case 6 => {
                              val oldSizes = display5(display5.length.-(1)).asInstanceOf[Array[Int]];
                              val newSizes = new Array[Int](oldSizes.length);
                              val lastSizesIndex = oldSizes.length.-(1);
                              Platform.arraycopy(oldSizes, 0, newSizes, 0, lastSizesIndex);
                              newSizes.update(lastSizesIndex, oldSizes(lastSizesIndex).+(deltaSize));
                              val idx = stabilizationIndex.>>(25).&(31);
                              display5 = copyOf(display5, idx, idx.+(2));
                              display5.update(idx, display4);
                              display5.update(display5.length.-(1), newSizes)
                            }
                            case _ => 
                          };
                          currentDepth.+=(1)
