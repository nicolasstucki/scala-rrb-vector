package scala {
  ...
  128).+(1));
            ...
            private def dropFront0(n: Int): RRBVector_q_128[A] = {
              if (transient)
                {
                  normalize(depth);
                  transient = false
                ...
                ();
              val vec = new RRBVector_q_128[A](this.endIndex.-(n));
              vec.initWithFocusFrom(this);
              if (vec.depth.>(1))
                {
                  vec.focusOn(n);
              ...
              if (xor.<(2097152))
                {
                  ...
                  display0 = new Array(1);
                  val _emptyTransientBlock = RRBVector_q_128.emptyTransientBlock;
