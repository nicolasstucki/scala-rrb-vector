package scala {
  ...
  128).+(1));
            ...
            private def dropFront0(n: Int): RRBVector_q_128_asserted[A] = {
              if (transient)
                {
                  normalize(depth);
                  transient = false
                ...
                ();
              val vec = new RRBVector_q_128_asserted[A](this.endIndex.-(n));
              vec.initWithFocusFrom(this);
              if (vec.depth.>(1))
                {
                  vec.focusOn(n);
                  ...
                  if (display4.!=(null))
                    {
                      assert(display3.!=(null));
                      if (focusDepth.<=(4))
                        assert(display4(focusRelax.>>(28).&(127)).==(null))
                      else
                        assert(display4(focus.>>(28).&(127)).==(null))
                    }
                  else
                    ();
                  if (display3.!=(null))
                    {
                      assert(display2.!=(null));
                      if (focusDepth.<=(3))
                        assert(display3(focusRelax.>>(21).&(127)).==(null))
                      else
                        assert(display3(focus.>>(21).&(127)).==(null))
                    }
                  else
                    ();
                  if (display2.!=(null))
                    {
                      assert(display1.!=(null));
                      if (focusDepth.<=(2))
                        assert(display2(focusRelax.>>(14).&(127)).==(null))
                      else
                        assert(display2(focus.>>(14).&(127)).==(null))
                    }
                  else
                    ();
                  if (display1.!=(null))
                    {
                      assert(display0.!=(null));
                      if (focusDepth.<=(1))
                        assert(display1(focusRelax.>>(7).&(127)).==(null))
                      else
                        assert(display1(focus.>>(7).&(127)).==(null))
                    }
                  else
                    ()
                };
                    ...
                    if (sizes.!=(null))
                    ...
                    else
                      {
                        ...
                        while (i.<(node.length.-(2))) 
                          {
                            checkSizes(node(i).asInstanceOf[Array[AnyRef]], currentDepth.-(1), (1).<<((7).*(currentDepth.-(1))));
                            i.+=(1)
                          }
                        ;
              ...
              if (xor.<(2097152))
                {
                  ...
                  display0 = new Array(1);
                  val _emptyTransientBlock = RRBVector_q_128_asserted.emptyTransientBlock;
