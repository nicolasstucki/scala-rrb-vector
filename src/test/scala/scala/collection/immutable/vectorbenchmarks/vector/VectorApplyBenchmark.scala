...
import scala.collection.immutable.vectorbenchmarks.rrbvector.balanced.RRBVectorAbstractBenchmark
import scala.collection.immutable.vectorutils.VectorGeneratorType

class VectorApplyIntBenchmark extends RRBVectorAbstractBenchmark[Int] with VectorGeneratorType.IntGenerator {
