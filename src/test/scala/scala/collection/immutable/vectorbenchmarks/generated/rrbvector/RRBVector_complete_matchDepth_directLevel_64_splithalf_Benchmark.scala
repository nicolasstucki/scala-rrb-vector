          ...
          package rrbvector {
            package balanced {
              ...
              class RRBVector_complete_matchDepth_directLevel_64_splithalf_AppendInt_Benchmark extends RRBVector_complete_matchDepth_directLevel_64_splithalf_Append_Benchmark[Int] with VectorGeneratorType.IntGenerator {
                def append(vec: RRBVector_complete_matchDepth_directLevel_64_splithalf[Int], n: Int, times: Int): Int = {
                  var i = 0;
                  var sum = 0;
                  while (i.<(times)) 
                    {
              ...
              class RRBVector_complete_matchDepth_directLevel_64_splithalf_AppendString_Benchmark extends RRBVector_complete_matchDepth_directLevel_64_splithalf_Append_Benchmark[String] with VectorGeneratorType.StringGenerator {
                val ref = "";
                def append(vec: RRBVector_complete_matchDepth_directLevel_64_splithalf[String], n: Int, times: Int): Int = {
                  var i = 0;
                  var sum = 0;
                  while (i.<(times)) 
                    {
              ...
              abstract class RRBVector_complete_matchDepth_directLevel_64_splithalf_Prepend_Benchmark[A] extends PrependBenchmarks[A] with RRBVector_complete_matchDepth_directLevel_64_splithalf_Benchmark[A]

              class RRBVector_complete_matchDepth_directLevel_64_splithalf_PrependInt_Benchmark extends RRBVector_complete_matchDepth_directLevel_64_splithalf_Prepend_Benchmark[Int] with VectorGeneratorType.IntGenerator {
                def prepend(vec: RRBVector_complete_matchDepth_directLevel_64_splithalf[Int], n: Int, times: Int): Int = {
                  var i = 0;
                  var sum = 0;
                  while (i.<(times)) 
                    {
              ...
              class RRBVector_complete_matchDepth_directLevel_64_splithalf_PrependString_Benchmark extends RRBVector_complete_matchDepth_directLevel_64_splithalf_Prepend_Benchmark[String] with VectorGeneratorType.StringGenerator {
                val ref = "";
                def prepend(vec: RRBVector_complete_matchDepth_directLevel_64_splithalf[String], n: Int, times: Int): Int = {
                  var i = 0;
                  var sum = 0;
                  while (i.<(times)) 
                    {
