          ...
          package rrbvector.closedblocks.fullrebalance {
            package balanced {
              ...
              trait GenRRBVectorClosedBlocksFullRebalanceBenchmark[A] extends BaseVectorBenchmark[A] with GenRRBVectorClosedBlocksFullRebalanceGenerator[A] {
                override def generateVectors(from: Int, to: Int, by: Int): org.scalameter.Gen[GenRRBVectorClosedBlocksFullRebalance[A]] = sizes(from, to, by).map(((size) => tabulatedVector(size)));
              ...
              class GenRRBVectorClosedBlocksFullRebalanceAppendIntBenchmark extends GenRRBVectorClosedBlocksFullRebalanceAppendBenchmark[Int] with VectorGeneratorType.IntGenerator {
                def sum1(vec: GenRRBVectorClosedBlocksFullRebalance[Int], times: Int): Int = {
                  var i = 0;
                  var v = vec;
                  var sum = 0;
                  while (i.<(times)) 
                ...
                def sum8(vec: GenRRBVectorClosedBlocksFullRebalance[Int], times: Int): Int = {
                  var i = 0;
                  var v = vec;
                  var sum = 0;
                  while (i.<(times)) 
              ...
              class GenRRBVectorClosedBlocksFullRebalanceAppendAnyRefBenchmark extends GenRRBVectorClosedBlocksFullRebalanceAppendBenchmark[AnyRef] with VectorGeneratorType.AnyRefGenerator {
                val obj = new Object();
                def sum1(vec: GenRRBVectorClosedBlocksFullRebalance[AnyRef], times: Int): Int = {
                  var i = 0;
                  var v = vec;
                  var sum = 0;
                  while (i.<(times)) 
                ...
                def sum8(vec: GenRRBVectorClosedBlocksFullRebalance[AnyRef], times: Int): Int = {
                  var i = 0;
                  var v = vec;
                  var sum = 0;
                  while (i.<(times)) 
            ...
            package xunbalanced {
              ...
              trait GenRRBVectorClosedBlocksFullRebalanceBenchmark[A] extends BaseVectorBenchmark[A] with GenRRBVectorClosedBlocksFullRebalanceGenerator[A] {
                override def generateVectors(from: Int, to: Int, by: Int): org.scalameter.Gen[GenRRBVectorClosedBlocksFullRebalance[A]] = sizes(from, to, by).map(((size) => randomVectorOfSize(size)(defaultVectorConfig())));
