          ...
          package rrbvector {
            package balanced {
              ...
              class RRBVector_complete_matchDepth_directLevel_128_splitbalanced_AppendInt_Benchmark extends RRBVector_complete_matchDepth_directLevel_128_splitbalanced_Append_Benchmark[Int] with VectorGeneratorType.IntGenerator {
                def append(vec: RRBVector_complete_matchDepth_directLevel_128_splitbalanced[Int], n: Int, times: Int): Int = {
                  var i = 0;
                  var sum = 0;
                  while (i.<(times)) 
                    {
              ...
              class RRBVector_complete_matchDepth_directLevel_128_splitbalanced_AppendString_Benchmark extends RRBVector_complete_matchDepth_directLevel_128_splitbalanced_Append_Benchmark[String] with VectorGeneratorType.StringGenerator {
                val ref = "";
                def append(vec: RRBVector_complete_matchDepth_directLevel_128_splitbalanced[String], n: Int, times: Int): Int = {
                  var i = 0;
                  var sum = 0;
                  while (i.<(times)) 
                    {
              ...
              abstract class RRBVector_complete_matchDepth_directLevel_128_splitbalanced_Prepend_Benchmark[A] extends PrependBenchmarks[A] with RRBVector_complete_matchDepth_directLevel_128_splitbalanced_Benchmark[A]

              class RRBVector_complete_matchDepth_directLevel_128_splitbalanced_PrependInt_Benchmark extends RRBVector_complete_matchDepth_directLevel_128_splitbalanced_Prepend_Benchmark[Int] with VectorGeneratorType.IntGenerator {
                def prepend(vec: RRBVector_complete_matchDepth_directLevel_128_splitbalanced[Int], n: Int, times: Int): Int = {
                  var i = 0;
                  var sum = 0;
                  while (i.<(times)) 
                    {
              ...
              class RRBVector_complete_matchDepth_directLevel_128_splitbalanced_PrependString_Benchmark extends RRBVector_complete_matchDepth_directLevel_128_splitbalanced_Prepend_Benchmark[String] with VectorGeneratorType.StringGenerator {
                val ref = "";
                def prepend(vec: RRBVector_complete_matchDepth_directLevel_128_splitbalanced[String], n: Int, times: Int): Int = {
                  var i = 0;
                  var sum = 0;
                  while (i.<(times)) 
                    {
