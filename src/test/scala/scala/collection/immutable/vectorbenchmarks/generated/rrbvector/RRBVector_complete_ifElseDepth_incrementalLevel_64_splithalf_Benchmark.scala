          ...
          package rrbvector {
            package balanced {
              ...
              class RRBVector_complete_ifElseDepth_incrementalLevel_64_splithalf_AppendInt_Benchmark extends RRBVector_complete_ifElseDepth_incrementalLevel_64_splithalf_Append_Benchmark[Int] with VectorGeneratorType.IntGenerator {
                def sum1(vec: RRBVector_complete_ifElseDepth_incrementalLevel_64_splithalf[Int], times: Int): Int = {
                  var i = 0;
                  var v = vec;
                  var sum = 0;
                  while (i.<(times)) 
                ...
                def sum8(vec: RRBVector_complete_ifElseDepth_incrementalLevel_64_splithalf[Int], times: Int): Int = {
                  var i = 0;
                  var v = vec;
                  var sum = 0;
                  while (i.<(times)) 
                ...
                def sum(vec: RRBVector_complete_ifElseDepth_incrementalLevel_64_splithalf[Int], n: Int, times: Int): Int = {
                  var i = 0;
                  var v = vec;
                  var sum = 0;
                  while (i.<(times)) 
              ...
              class RRBVector_complete_ifElseDepth_incrementalLevel_64_splithalf_AppendString_Benchmark extends RRBVector_complete_ifElseDepth_incrementalLevel_64_splithalf_Append_Benchmark[String] with VectorGeneratorType.StringGenerator {
                val ref = "";
                def sum1(vec: RRBVector_complete_ifElseDepth_incrementalLevel_64_splithalf[String], times: Int): Int = {
                  var i = 0;
                  var v = vec;
                  var sum = 0;
                  while (i.<(times)) 
                ...
                def sum8(vec: RRBVector_complete_ifElseDepth_incrementalLevel_64_splithalf[String], times: Int): Int = {
                  var i = 0;
                  var v = vec;
                  var sum = 0;
                  while (i.<(times)) 
                ...
                def sum(vec: RRBVector_complete_ifElseDepth_incrementalLevel_64_splithalf[String], n: Int, times: Int): Int = {
                  var i = 0;
                  var v = vec;
                  var sum = 0;
                  while (i.<(times)) 
